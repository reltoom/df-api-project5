...
ALLOWED_HOSTS = ['localhost', os.environ.get('ALLOWED_HOST'), '127.0.0.1', 'https://df-api-project5-f27c63867984.herokuapp.com/', '8000-reltoom-dfapiproject5-2b1tujcrgz3.ws.codeinstitute-ide.net',]
